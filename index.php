    ...
    <div class="page-wrap">
        ...
        <section id="main">
            ...
            <section id="banner">
                <div class="inner">
                    <h1>clichepy</h1>
                    <p>“ I’m much more me when I’m with you.“</p>
                    <ul class="actions">
                        <li>
                            <a href="#galleries" class="button alt scrolly big">Our Gallery</a>
                        </li>
                    </ul>
                </div>
            </section>
            ...
            <section id="contact">
                ...
                <div class="social column">
                    <h3>About Us</h3>
                    <h4>ครบรอบสามเดือนแล้วนะเธอที่อยู่ด้วยกัน</h4>
                    <p>เค้าขอโทษที่ทำให้แยมเสียใจนะ เค้าขอโทษที่ร้องไห้บ่อย เค้าขอโทษที่ผลักไสในบางครั้งนะ ขอบคุณแยมที่อยู่เป็นความสุขให้เรานะครับ อยู่เรียนรู้ รัก มีความสุข ไปกันเรื่อยๆเลยนะครับ ให้เราสองคนเติบโตไปด้วยกันนะครับ เค้ารักแยมมากนะครับ 💘

                    </p>
                    <h3>Only Mine</h3>
                    <ul class="icons">

                        <li><a href="https://www.facebook.com/sudarat.wangvisai" class="icon fa-facebook" target="_blank"><span class="label">Facebook</span></a></li>
                        <li><a href="https://www.instagram.com/yamsudaaa/?hl=th" class="icon fa-instagram" target="_blank"><span class="label">Instagram</span></a></li>
                    </ul>
                </div>
